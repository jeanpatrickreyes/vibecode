...
const translations: Record<Language, Record<string, string>> = {
	ar: {
		...
		'pricing.free.hosting': 'استضافة مجانية',
		...
		'pricing.business.price': '199 د.إ / شهر',
	...
	en: {
		...
		'pricing.free.price': '0 AED / month',
		...
		'pricing.free.hosting': 'Free hosting',
		...
		'pricing.pro.title': 'Pro',
		'pricing.pro.price': '49 AED / month',
		...
		'pricing.business.title': 'Business',
		'pricing.business.price': '199 AED / month',
